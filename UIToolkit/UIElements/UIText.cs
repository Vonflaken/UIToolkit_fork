...
public class UIText : System.Object 
{
	...
	{
		return addTextInstance( text, xPos, yPos, false, 1f );
	}
	
	
	public UITextInstance addTextInstance( string text, float xPos, float yPos, bool touchable, float scale )
	{
		return addTextInstance( text, xPos, yPos, touchable, scale, 1 );
	}
	
	
	public UITextInstance addTextInstance( string text, float xPos, float yPos, bool touchable, float scale, int depth )
	{
		return addTextInstance( text, xPos, yPos, touchable, scale, depth, Color.white );
	}

	
	public UITextInstance addTextInstance( string text, float xPos, float yPos, bool touchable, float scale, int depth, Color color )
	{
		return addTextInstance( text, xPos, yPos, touchable, scale, depth, color, this.alignMode, this.verticalAlignMode );
	}
	
	
	public UITextInstance addTextInstance( string text, float xPos, float yPos, bool touchable, float scale, int depth, Color color, UITextAlignMode alignMode, UITextVerticalAlignMode verticalAlignMode )
	{
		return addTextInstance( text, xPos, yPos, touchable, scale, depth, new Color[] { color }, alignMode, verticalAlignMode );
	}
	
	
	public UITextInstance addTextInstance( string text, float xPos, float yPos, bool touchable, float scale, int depth, Color[] colors, UITextAlignMode alignMode, UITextVerticalAlignMode verticalAlignMode )
	{
		if( forceLowAscii )
			forceLowAsciiString( ref text );
		
		var textInstance = new UITextInstance( this, text, xPos, yPos, touchable, scale, depth, colors, alignMode, verticalAlignMode );
