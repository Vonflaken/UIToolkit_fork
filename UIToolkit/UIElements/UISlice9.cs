...
public class UISlice9 : UITouchableSprite
{
	...
	public static UISlice9 create( UIToolkit manager, string filename, string highlightedFilename, int xPos, int yPos, int width, int height, int sTP, int sRT, int sBT, int sLT, int depth )
	{
		...
		// create the button
		return new UISlice9( manager, filename, frame, depth, normalTI.uvRect, highlightedTI.uvRect, width, height, sTP, sRT, sBT, sLT );
	}
	...
	/// Left Margin
	/// </param>
	public UISlice9( UIToolkit manager, string filename, Rect frame, int depth, UIUVRect uvFrame, UIUVRect highlightedUVframe, int width, int height, int sTP, int sRT, int sBT, int sLT ):base( frame, depth, uvFrame )
	{
		...
		manager.addSprite( spriteSlices[0], spriteSlices[0].Filename );
		...
		manager.addSprite( spriteSlices[1], spriteSlices[1].Filename );
		...
		manager.addSprite( spriteSlices[2], spriteSlices[2].Filename );
		...
		manager.addSprite( spriteSlices[3], spriteSlices[3].Filename );		
		...
		manager.addSprite( spriteSlices[4], spriteSlices[4].Filename );		
		...
		manager.addSprite( spriteSlices[5], spriteSlices[5].Filename );		
		...
		manager.addSprite( spriteSlices[6], spriteSlices[6].Filename );		
		...
		manager.addSprite( spriteSlices[7], spriteSlices[7].Filename );
		...
		manager.addSprite( spriteSlices[8], spriteSlices[8].Filename );
