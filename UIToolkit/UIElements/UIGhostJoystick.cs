...
public class UIGhostJoystick : UITouchableSprite
{
	...
	public static UIGhostJoystick create( UIToolkit manager, string joystickFilename, Rect hitArea )
	{
		...
		return new UIGhostJoystick( manager, joystickFilename, hitArea, 1, joystick);
	}

	
	public UIGhostJoystick( UIToolkit manager, string filename, Rect frame, int depth, UISprite joystickSprite)
