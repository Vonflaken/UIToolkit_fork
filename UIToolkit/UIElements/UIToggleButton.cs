...
public class UIToggleButton : UITouchableSprite
{
	...
	public static UIToggleButton create( UIToolkit manager, string filename, string selectedFilename, string highlightedFilename, int xPos, int yPos, int depth )
	{
		...
		return new UIToggleButton( manager, filename, frame, depth, textureInfo.uvRect, selectedTI.uvRect, highlightedTI.uvRect );
	}
	
	
	public UIToggleButton( UIToolkit manager, string filename, Rect frame, int depth, UIUVRect uvFrame, UIUVRect selectedUVframe, UIUVRect highlightedUVframe ):base( frame, depth, uvFrame )
	{
