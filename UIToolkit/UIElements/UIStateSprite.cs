...
public class UIStateSprite : UISprite
{
    ...
    public static UIStateSprite create(UIToolkit manager, string[] filenames, int xPos, int yPos, int depth)
    {
        ...
        // create the button
        UIStateSprite sprite = new UIStateSprite(manager, filenames[0], frame, depth, firstNormalTI.uvRect);
        // Add frames
    ...
    public UIStateSprite(UIToolkit manager, string filename, Rect frame, int depth, UIUVRect uvFrame)
