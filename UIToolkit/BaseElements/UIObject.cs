	...
	public UIObject parentUIObject
	{
		...
		set
		{
			...
			else
			{
				...
				else if ( this is UIAbstractContainer )
					clientTransform.parent = UI.firstToolkit.transform; // HACK: transform setted from fixed manager (the first one)
				else
